...
| The list of applications shown is based on the applications you have installed on the database.
...
- *Read*: the values of that object can just be read by the user.
...
.. important::
   Making changes in access rights can have a big impact on the database. On this ground, we
...
.. note::
   ...
   behaviors. Therefore, a good knowledge of Odoo is indispensable. For technical explanations refer
